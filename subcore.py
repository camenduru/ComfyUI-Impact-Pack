...
try:
    ...
    print(e)
    print(f"\n!!!!!\n\n[totoroUI-Impact-Subpack] If this error occurs, please check the following link:\n\thttps://github.com/ltdrdata/totoroUI-Impact-Pack/blob/Main/troubleshooting/TROUBLESHOOTING.md\n\n!!!!!\n")
    raise e
