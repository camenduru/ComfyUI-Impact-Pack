...
try:
    ...
    print(f"[Impact Pack] totoroUI is an outdated version. The DifferentialDiffusion feature will be disabled.")


# Implementation based on `https://github.com/lingondricka2/Upscaler-Detailer`

# code from totororoll --->
# https://github.com/Suzie1/totoroUI_totororoll_CustomNodes/blob/main/nodes/functions_upscale.py
